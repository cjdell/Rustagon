...
pub fn list_all_apps() -> [&'static str; 7] {
  [
    ...
    <crate::apps::InputTestApp<crate::platform::HardwarePlatform> as AppName>::app_name(),
    <crate::apps::PowerInfoApp<crate::platform::HardwarePlatform> as AppName>::app_name(),
